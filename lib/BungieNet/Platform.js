...
var _PlatformRequest = require("./PlatformRequest");
...
var Platform = function () {
  ...
  _createClass(Platform, [{
    ...
    value: function _prepareRequest(frame) {
      ...
      var listeners = (_listeners = {}, _defineProperty(_listeners, _PlatformRequest2.default.events.beforeSend, this._frameBeforeSend), _defineProperty(_listeners, _PlatformRequest2.default.events.httpSuccess, this._frameHttpSuccess), _defineProperty(_listeners, _PlatformRequest2.default.events.httpError, this._frameHttpError), _defineProperty(_listeners, _PlatformRequest2.default.events.httpDone, this._frameHttpDone), _defineProperty(_listeners, _PlatformRequest2.default.events.responseParsed, this._frameResponseParsed), _defineProperty(_listeners, _PlatformRequest2.default.events.error, this._frameError), _defineProperty(_listeners, _PlatformRequest2.default.events.success, this._frameSuccess), _defineProperty(_listeners, _PlatformRequest2.default.events.done, this._frameDone), _listeners);
    ...
    value: function _tryFrame() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this4._options.maxConcurrent >= 0) {
          if (_this4._frameManager.getActive().size >= _this4._options.maxConcurrent) {
            _BungieNet2.default.logger.log("warn", "Cannot get a frame - too many active requests");
            return reject();
          }
        }

        var frame = _this4._frameManager.getFrame();
    ...
    key: "addPlugin",
    value: function addPlugin(p) {
      this._plugins.add(p);
    }
  }, {
    key: "removePlugin",
    value: function removePlugin(p) {
    ...
    value: function getAccessTokensFromCode() {
    ...
    value: function getAccessTokensFromRefreshToken() {
    ...
    value: function getApplicationApiKeys(p1) {
      return this._serviceRequest(new _Request2.default(_urijs2.default.expand("/App/ApplicationApiKeys/{p1}/", {
        p1: p1
      })));
    }
    ...
    value: function getAuthorizationForUserAndApplication(p1, p2) {
      return this._serviceRequest(new _Request2.default(_urijs2.default.expand("/App/Authorization/{p1}/{p2}/", {
        p1: p1,
        p2: p2
      })));
    }
    ...
    value: function getAuthorizations(p1) {
      return this._serviceRequest(new _Request2.default(_urijs2.default.expand("/App/Authorizations/{p1}/", {
        p1: p1
      })));
    }
    ...
    value: function revokeAuthorization(p1, p2) {
      return this._serviceRequest(new _Request2.default(_urijs2.default.expand("/App/RevokeAuthorization/{p1}/{p2}/", {
        p1: p1,
        p2: p2
      }), "POST", {}));
    }
    ...
    value: function buyItem() {
      return this._serviceRequest(new _Request2.default(new _urijs2.default("/Destiny/BuyItem/"), "POST", {}));
    }
    ...
    key: "refundItem",
    value: function refundItem(p1) {
      return this._serviceRequest(new _Request2.default(_urijs2.default.expand("/Destiny/{p1}/RefundItem/", {
        p1: p1
      }), "POST", {}));
    }
    ...
    value: function getAdminCommunityLiveStatuses(p1, p2, name) {
      return this._serviceRequest(new _Request2.default(_urijs2.default.expand("/CommunityContent/Live/Admin/{p1}/{p2}/{?name}", {
        p1: p1,
        p2: p2,
        name: name
      }), "POST", {}));
